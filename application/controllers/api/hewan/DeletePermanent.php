...
class DeletePermanent extends REST_Controller
{
    ...
    public function index_post($id_hewan)
    {
        if ($id_hewan === null) {
            ...
            if ($this->Hewan_model->deletePermanentHewan($id_hewan) > 0) {
                //ok
                $this->response([
                    'status' => true,
                    'id_hewan' => $id_hewan,
            ...
            } else if ($this->Hewan_model->deletePermanentHewan($id_hewan) == 0) {
                ////id not found
                $this->response([
                    'status' => false,
            ...
            } else if ($this->Hewan_model->deletePermanentHewan($id_hewan) == -1) {
                // ada foreign key
                $this->response([
                    'status' => false,
