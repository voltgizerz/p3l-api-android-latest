...
class Delete extends REST_Controller
{
    ...
    public function index_post($id)
    {
        ...
        if ($id === null) {
            ...
            if ($this->Jenis_Hewan_model->deleteJenisHewan($id) > 0) {
                //ok
                ...
                # code...
            } else if ($this->Jenis_Hewan_model->deleteJenisHewan($id) == 0) {
                ////id not found
                $this->response([
                    'status' => false,
            ...
            } else if ($this->Jenis_Hewan_model->deleteJenisHewan($id) == -1) {
                // ada foreign key
                $this->response([
                    'status' => false,
